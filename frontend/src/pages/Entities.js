...
function DataCenter() {
  ...
  // CONNECTOR DETAILS
  // =========================
  const getConnectorDetails = (src) => {
    if (src.id === 1) {
      return {
        name: "eCourts",
        logo:
          "https://services.ecourts.gov.in/ecourtindia_v6/images/ecourts-logo.png",
      };
    }
  ...
  return (
    <div className="alerts-container">
      ...
      */}
      ...
      <div className="alerts-list">
        {sources.map((src) => {
          const connector = getConnectorDetails(src);
